        ...
        <Row type="flex" justify={"space-between"} className={`${className}`} gutter={1}>
          <Col sm={24} md={15}>
            <QueueAnim
              ...
              delay={1000}
            >
              <h1 key="h1" className="heading-info">Maximize Your Advertising Budget with Our Advanced Technology</h1>
              <p className="main-info" key="p">
                Yet bed any for travelling assistance indulgence unpleasing. Not thoughts all exercise blessing. Indulgence way everything joy. Yet bed any for travelling assistance in.
              </p>
